...
from data_converter import waymo_converter as waymo_converter
from data_converter import mantruck_converter as mantruck_converter
...
def mantruck_data_prep(
    ...
    """Prepare data related to mantruck dataset.
    ...
    if load_augmented is None:
        # otherwise, infos must have been created, we just skip.
        mantruck_converter.create_mantruck_infos(
            root_path, info_prefix, version=version, max_sweeps=max_sweeps
        )
...
if __name__ == "__main__":
    ...
    elif args.dataset == "mantruck" and args.version == "v1.0-mini":
        train_version = f"{args.version}"
        mantruck_data_prep(
            root_path=args.root_path,
            info_prefix=args.extra_tag,
            version=train_version,
            dataset_name="MANTruckScenesDataset",
            out_dir=args.out_dir,
            max_sweeps=args.max_sweeps,
            load_augmented=load_augmented,
        )
