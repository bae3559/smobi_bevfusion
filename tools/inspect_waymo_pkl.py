#!/usr/bin/env python3
"""Inspect Waymo pickle files to see their structure"""
...
if __name__ == "__main__":
    # Inspect infos files
    inspect_infos("data/waymo/Waymo_mini/waymo_infos_train.pkl")
    inspect_infos("data/waymo/Waymo_mini/waymo_infos_val.pkl")

    # Inspect dbinfos file
    try:
        inspect_dbinfos("data/waymo/Waymo_mini/waymo_dbinfos_train.pkl")
    except FileNotFoundError:
        print("\n" + "="*80)
        print("waymo_dbinfos_train.pkl not found (may not exist yet)")
        print("="*80)
